    ...
    <MainLayout>
      <Container className="policy">
        ...
        <p>
          ...
          безопасности персональных данных, предпринимаемые Янченко Максимом
          Валерьевичем (далее – Оператор).
        </p>
        <ul>
          <li>
        ...
        <ul>
          ...
          <li>
            5.4. Адрес фактического места проживания и регистрации по месту
          ...
          <li>
            5.8. Обработка персональных данных, разрешенных для распространения,
        ...
        <ul>
          ...
          <li>
            ...
            электронной почты smoke-time-opt@mail.ru с пометкой «Отказ от
        ...
        <ul>
          <li>
            ...
            <ul>
              <li>
                ...
                связанные с вашей деятельностью, например, если ваша
                деятельность связана с информационными технологиями, в частности
          ...
          <li>
            ...
            https://smoketimeopt.ru или направленные Оператору посредством
        ...
        <ul>
          ...
          <li>
            ...
            Оператора smoke-time-opt@mail.ru с пометкой «Актуализация
            персональных данных».
          </li>
          <li>
            ...
            smoke-time-opt@mail.ru с пометкой «Отзыв согласия на обработку
            персональных данных».
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            к Оператору с помощью электронной почты smoke-time-opt@mail.ru.
          </li>
          <li>
          ...
          <li>
            ...
            сети Интернет по адресу https://smoketimeopt.ru/policy.
          </li>
        </ul>
      </Container>
